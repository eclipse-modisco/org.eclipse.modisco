...
public class CodeSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case CodePackage.PACKAGE: {
				org.eclipse.modisco.omg.kdm.code.Package package_ = (org.eclipse.modisco.omg.kdm.code.Package)theEObject;
	 ...
	 * @generated
	 */
	public T casePackage(org.eclipse.modisco.omg.kdm.code.Package object) {
		return null;
	}
