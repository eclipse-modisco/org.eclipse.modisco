 ...
 *   <li>{@link org.eclipse.modisco.java.emf.classic.impl.ModifierImpl#isStatic <em>Static</em>}</li>
 *   <li>{@link org.eclipse.modisco.java.emf.classic.impl.ModifierImpl#isTransient <em>Transient</em>}</li>
 *   <li>{@link org.eclipse.modisco.java.emf.classic.impl.ModifierImpl#isVolatile <em>Volatile</em>}</li>
 *   <li>{@link org.eclipse.modisco.java.emf.classic.impl.ModifierImpl#isNative <em>Native</em>}</li>
 *   <li>{@link org.eclipse.modisco.java.emf.classic.impl.ModifierImpl#isStrictfp <em>Strictfp</em>}</li>
 *   <li>{@link org.eclipse.modisco.java.emf.classic.impl.ModifierImpl#isSynchronized <em>Synchronized</em>}</li>
 *   <li>{@link org.eclipse.modisco.java.emf.classic.impl.ModifierImpl#getBodyDeclaration <em>Body Declaration</em>}</li>
 *   <li>{@link org.eclipse.modisco.java.emf.classic.impl.ModifierImpl#getSingleVariableDeclaration <em>Single Variable Declaration</em>}</li>
