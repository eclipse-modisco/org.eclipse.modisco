...
public class JavaQueryFactoryImpl extends EFactoryImpl implements JavaQueryFactory {
	...
	public static JavaQueryFactory init() {
		try {
			JavaQueryFactory theJavaQueryFactory = (JavaQueryFactory)EPackage.Registry.INSTANCE.getEFactory("http://www.eclipse.org/modisco/facet/query/java/0.2.incubation/javaquery"); //$NON-NLS-1$ 
