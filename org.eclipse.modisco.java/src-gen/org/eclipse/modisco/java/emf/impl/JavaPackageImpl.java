...
public class JavaPackageImpl extends EPackageImpl implements JavaPackage {
	...
	public EClass getCreationReference() {
		if (creationReferenceEClass == null) {
			creationReferenceEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(JavaPackage.eNS_URI).getEClassifiers().get(41);
		}
	...
	public EClass getExpressionMethodReference() {
		if (expressionMethodReferenceEClass == null) {
			expressionMethodReferenceEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(JavaPackage.eNS_URI).getEClassifiers().get(50);
		}
	...
	public EClass getLambdaExpression() {
		if (lambdaExpressionEClass == null) {
			lambdaExpressionEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(JavaPackage.eNS_URI).getEClassifiers().get(70);
		}
	...
	public EClass getMethodReference() {
		if (methodReferenceEClass == null) {
			methodReferenceEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(JavaPackage.eNS_URI).getEClassifiers().get(80);
		}
	...
	public EClass getUnionType() {
		if (unionTypeEClass == null) {
			unionTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(JavaPackage.eNS_URI).getEClassifiers().get(150);
		}
