 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.modisco.java.nousages.impl.CreationReferenceImpl#getType <em>Type</em>}</li>
 *   <li>{@link org.eclipse.modisco.java.nousages.impl.CreationReferenceImpl#getTypeArguments <em>Type Arguments</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CreationReferenceImpl extends MethodReferenceImpl implements CreationReference {
		...
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, JavaPackage.CREATION_REFERENCE__TYPE, oldType, type));
			}
		}
		return type;
	}
	...
	public void setType(Type newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JavaPackage.CREATION_REFERENCE__TYPE, oldType, type));
	}
	...
	public EList<Type> getTypeArguments() {
		if (typeArguments == null) {
			typeArguments = new EObjectResolvingEList<Type>(Type.class, this, JavaPackage.CREATION_REFERENCE__TYPE_ARGUMENTS);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case JavaPackage.CREATION_REFERENCE__TYPE:
				if (resolve) return getType();
				return basicGetType();
			case JavaPackage.CREATION_REFERENCE__TYPE_ARGUMENTS:
