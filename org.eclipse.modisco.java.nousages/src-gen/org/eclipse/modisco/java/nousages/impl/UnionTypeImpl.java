 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.modisco.java.nousages.impl.UnionTypeImpl#getTypes <em>Types</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UnionTypeImpl extends TypeImpl implements UnionType {
	...
	protected EClass eStaticClass() {
		return JavaPackage.eINSTANCE.getUnionType();
	}
	...
	public EList<Type> getTypes() {
		if (types == null) {
			types = new EObjectResolvingEList<Type>(Type.class, this, JavaPackage.UNION_TYPE__TYPES);
		}
		return types;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case JavaPackage.UNION_TYPE__TYPES:
				return getTypes();
		}
