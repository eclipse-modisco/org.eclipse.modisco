 ...
 *   <li>{@link org.eclipse.modisco.java.cdo.impl.ModifierImpl#isStatic <em>Static</em>}</li>
 *   <li>{@link org.eclipse.modisco.java.cdo.impl.ModifierImpl#isTransient <em>Transient</em>}</li>
 *   <li>{@link org.eclipse.modisco.java.cdo.impl.ModifierImpl#isVolatile <em>Volatile</em>}</li>
 *   <li>{@link org.eclipse.modisco.java.cdo.impl.ModifierImpl#isNative <em>Native</em>}</li>
 *   <li>{@link org.eclipse.modisco.java.cdo.impl.ModifierImpl#isStrictfp <em>Strictfp</em>}</li>
 *   <li>{@link org.eclipse.modisco.java.cdo.impl.ModifierImpl#isSynchronized <em>Synchronized</em>}</li>
 *   <li>{@link org.eclipse.modisco.java.cdo.impl.ModifierImpl#getBodyDeclaration <em>Body Declaration</em>}</li>
 *   <li>{@link org.eclipse.modisco.java.cdo.impl.ModifierImpl#getSingleVariableDeclaration <em>Single Variable Declaration</em>}</li>
