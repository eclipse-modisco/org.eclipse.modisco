...
public class EfacetcatalogFactoryImpl extends EFactoryImpl implements EfacetcatalogFactory {
	...
	public static EfacetcatalogFactory init() {
		try {
			EfacetcatalogFactory theEfacetcatalogFactory = (EfacetcatalogFactory)EPackage.Registry.INSTANCE.getEFactory("http://www.eclipse.org/modisco/facet/efacet/0.2.incubation/efacetcatalog"); //$NON-NLS-1$ 
