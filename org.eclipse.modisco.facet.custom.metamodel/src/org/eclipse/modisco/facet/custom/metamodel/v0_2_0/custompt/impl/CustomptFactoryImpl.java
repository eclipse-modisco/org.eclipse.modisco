...
public class CustomptFactoryImpl extends EFactoryImpl implements CustomptFactory {
	...
	public static CustomptFactory init() {
		try {
			CustomptFactory theCustomptFactory = (CustomptFactory)EPackage.Registry.INSTANCE.getEFactory("http://www.eclipse.org/modisco/facet/custom/0.2.incubation/custom_primitive_types"); 
